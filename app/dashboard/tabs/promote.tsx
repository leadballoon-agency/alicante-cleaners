...
export default function PromoteTab({ cleaner, bookings }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Invite existing (off-platform) clients */}
      <div className="bg-white rounded-2xl p-5 border border-[#EBEBEB]">
        <div className="flex items-start gap-3 mb-3">
          <span className="text-2xl">📇</span>
          <div>
            <h3 className="font-medium text-[#1A1A1A]">{t('promote.invite.title')}</h3>
            <p className="text-sm text-[#6B6B6B] mt-1">{t('promote.invite.body')}</p>
          </div>
        </div>
        ...
        <ul className="space-y-1.5 mb-4">
          <li className="flex items-start gap-2 text-xs text-[#6B6B6B]">
            ...
            <span>{t('promote.invite.benefit.reviews')}</span>
          </li>
          <li className="flex items-start gap-2 text-xs text-[#6B6B6B]">
            <span className="text-[#C4785A]">✓</span>
            <span>{t('promote.invite.benefit.reminders')}</span>
          </li>
          <li className="flex items-start gap-2 text-xs text-[#6B6B6B]">
            <span className="text-[#C4785A]">✓</span>
            <span>{t('promote.invite.benefit.noChange')}</span>
          </li>
        </ul>

        {/* Pre-written message preview */}
        <div className="bg-[#FAFAF8] rounded-lg p-3 mb-3 text-sm text-[#6B6B6B]">
          <p className="line-clamp-3">&quot;{inviteMessage}&quot;</p>
        </div>

        <div className="space-y-2">
          <button
            onClick={handleShareInvite}
            className="flex items-center justify-center gap-2 w-full bg-[#25D366] text-white py-3 rounded-xl text-sm font-medium active:scale-[0.98] transition-all"
          >
            ...
            <span>{t('promote.invite.shareButton')}</span>
          </button>
          ...
          >
            ...
            <span>{inviteCopied ? t('promote.invite.copied') : t('promote.invite.copyButton')}</span>
          </button>
        </div>
      </div>
