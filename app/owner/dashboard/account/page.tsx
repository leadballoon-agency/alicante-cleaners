...
const PAUSE_REASONS = [
  { id: 'vacation', label: 'Property not in use', icon: '🏖️' },
  { id: 'personal', label: 'Personal reasons', icon: '🏠' },
  { id: 'busy', label: 'Taking a break', icon: '⏰' },
  { id: 'other', label: 'Other reason', icon: '💭' },
]

const DELETE_REASONS = [
  { id: 'sold_property', label: 'Sold my property', icon: '🏡' },
  { id: 'not_using', label: 'Not using the service anymore', icon: '😴' },
    ...
    return (
      <div className="min-h-screen bg-[#FAFAF8] flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <Link href="/owner/dashboard" className="text-[#C4785A] mt-2 inline-block">
            Return to dashboard
          </Link>
        </div>
      </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-amber-700">
                  Your account is on pause. You won&apos;t receive booking reminders.
        ...
        <div className="bg-white rounded-2xl p-6 border border-[#EBEBEB]">
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div className="bg-[#F5F5F3] rounded-xl p-4 text-center">
              <Home className="w-5 h-5 mx-auto mb-2 text-[#6B6B6B]" />
              <p className="text-2xl font-semibold text-[#1A1A1A]">
                {accountData.stats.propertyCount || 0}
              </p>
              <p className="text-xs text-[#6B6B6B]">Properties</p>
            </div>
            <div className="bg-[#F5F5F3] rounded-xl p-4 text-center">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-[#6B6B6B] mb-4">
                    Not using your property for a while? Pause your account and
                    we&apos;ll keep everything safe until you&apos;re back.
                  </p>
                  <ul className="text-sm text-[#6B6B6B] mb-4 space-y-1">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      Properties and preferences saved
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
            ...
            <div className="bg-white rounded-2xl p-6 border border-[#EBEBEB]">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-[#6B6B6B] mb-4">
                    Leaving VillaCare? We&apos;ll be sad to see you go. Deletion includes a
            ...
            <div className="bg-[#FFF8E7] rounded-xl p-4 mb-6">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-[#6B6B6B]">
                  ...
                  Your properties and preferences will be saved for when you return.
                </p>
              </div>
            </div>
