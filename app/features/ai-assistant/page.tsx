...
const translations = {
  en: {
    ...
    readyText: 'Join VillaCare and your profile will have its own AI assistant. It works 24/7, speaks 7 languages, and never misses an inquiry.',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'No. The AI assistant is included with your VillaCare profile at no additional cost.',
      },
    ],
  },
  es: {
    ...
    readyText: 'Únete a VillaCare y tu perfil tendrá su propio asistente IA. Funciona 24/7, habla 7 idiomas y nunca pierde una consulta.',
    ...
    faqs: [
      ...
      {
        q: '¿Esto cuesta extra?',
        a: 'No. El asistente IA está incluido con tu perfil de VillaCare sin coste adicional.',
      },
    ],
  },
}
